...
const render = (content) => {
    return (
        ...
        <div className="top-bar">
            <div className="title">
                <a href="./index.html"> <img className="logo" src="images/logo.png" alt="Green Book Logo"/></a>
                <h1 className="header">Yusof Bandar's Bookmarks</h1>
                <button className="clear-button github-logo" aria-label="Github logo linking to the github repo" alt="Github logo">
                ...
                <button className="clear-button edit-logo" aria-label="Pencil icon linking to the bookmarks markdown file" alt="Pencil">
            ...
            <span className="navigation"><a href="./index.html">Index</a> <a href="./favourite.html">Favourite</a> <a href="./readingList.html">Reading</a></span>
        </div>
